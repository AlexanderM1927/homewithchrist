export default {
  ...
  advisor: {
    ...
    startVoiceInput: 'Dictar mensaje',
    stopVoiceInput: 'Detener dictado',
    voiceListening: 'Escuchando... puedes corregir el texto antes de enviarlo.',
    voicePermissionReady: 'Permiso concedido. Toca el micrófono de nuevo para empezar a dictar.',
    voiceUnavailable: 'Tu dispositivo o navegador no permite dictar mensajes por voz.',
    voicePermissionDenied: 'No se concedio permiso para usar el microfono.',
    voiceStartTimeout: 'No pudimos iniciar el dictado. Intenta tocar el micrófono de nuevo.',
    voiceError: 'No se pudo convertir tu voz en texto. Intenta de nuevo.',
