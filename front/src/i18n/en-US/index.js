export default {
  ...
  diary: {
    ...
    image: 'Image',
    imageHint: 'JPG, JPEG, PNG or WEBP. Optional.',
    imageEditHint: 'Select a new JPG, JPEG, PNG, or WEBP image to replace the current one.',
  ...
  bible: {
    ...
    selectionHint: 'Select verses and share a link with the exact reference.',
    clearSelection: 'Clear selection',
    shareSelection: 'Share selection',
    shareText: 'Check out these verses',
    shareCopied: 'Verse link copied',
    shareError: 'The selection could not be shared',
  ...
  advisor: {
    ...
    startVoiceInput: 'Dictate message',
    stopVoiceInput: 'Stop dictation',
    voiceListening: 'Listening... you can edit the text before sending it.',
    voicePermissionReady: 'Permission granted. Tap the microphone again to start dictation.',
    voiceUnavailable: 'Your device or browser cannot dictate messages by voice.',
    voicePermissionDenied: 'Microphone permission was not granted.',
    voiceStartTimeout: 'We could not start dictation. Please tap the microphone again.',
    voiceError: 'Your voice could not be converted to text. Please try again.',
